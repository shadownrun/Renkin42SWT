...
public class EntityBrokenNetherBrick extends EntityThrowable {

	public EntityBrokenNetherBrick(World par1World) {
		super(par1World);
	}

	public EntityBrokenNetherBrick(World par1World, EntityLivingBase par2EntityLiving) {
		super(par1World, par2EntityLiving);
	}

	public EntityBrokenNetherBrick(World par1World, double par2, double par4,
			double par6) {
