	...
	protected void onImpact(MovingObjectPosition par1MovingObjectPosition) {
		if (par1MovingObjectPosition.entityHit != null) {
            ...
            if (!this.worldObj.isRemote && StuffWorthThrowing.itemStatusEffects) {
            	...
            	entityLiving.addPotionEffect(new PotionEffect(Potion.blindness.getId(), 200, 0));
            	entityLiving.addPotionEffect(new PotionEffect(Potion.wither.getId(), 200, 0));
            }
		...
		if (!this.worldObj.isRemote && StuffWorthThrowing.soulSandSpawn && this.rand.nextInt(16) == 0)
        {
