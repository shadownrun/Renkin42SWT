...
public class ItemSwiftDust extends Item {

	public ItemSwiftDust(int par1, String unlocalizedName) {
		super(par1);
		setMaxStackSize(16);
	...
	public ItemStack onItemRightClick(ItemStack par1ItemStack, World par2World, EntityPlayer par3EntityPlayer)
    {
        if (StuffWorthThrowingConfig.itemsThrowable) {
            ...
            {
                par2World.spawnEntityInWorld(new EntitySwiftDust(par2World, par3EntityPlayer));
            }
        }
