...
public class ItemBrokenCSBrick extends Item {

	public ItemBrokenCSBrick(int par1, String unlocalizedName) {
		super(par1);
		setMaxStackSize(16);
	...
	public ItemStack onItemRightClick(ItemStack par1ItemStack, World par2World, EntityPlayer par3EntityPlayer)
    {
        if (StuffWorthThrowingConfig.itemsThrowable) {
            ...
            {
                par2World.spawnEntityInWorld(new EntityBrokenCSBrick(par2World, par3EntityPlayer));
            }
        }
