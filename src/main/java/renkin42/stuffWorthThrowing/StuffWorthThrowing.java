...
public class StuffWorthThrowing {
	...
	public void load(FMLInitializationEvent event) {
		...
		EntityRegistry.registerModEntity(EntitySandPile.class, "sandPile", 210,
				this, 64, 1, true);
		EntityRegistry.registerModEntity(EntitySoulSandPile.class,
				"soulSandPile", 211, this, 64, 1, true);
		EntityRegistry.registerModEntity(EntityRock.class, "rock", 212, this,
				64, 1, true);
		EntityRegistry.registerModEntity(EntitySnowballRock.class,
				"snowballRock", 213, this, 64, 1, true);
		EntityRegistry.registerModEntity(EntityTorturedSoul.class,
				"torturedSoul", 214, this, 32, 1, true);
		EntityRegistry.registerModEntity(EntityBrokenBrick.class,
				"brokenBrick", 215, this, 64, 1, true);
		EntityRegistry.registerModEntity(EntityBrokenNetherBrick.class,
				"brokenNetherBrick", 216, this, 64, 1, true);
		EntityRegistry.registerModEntity(EntityBrokenSpectralBrick.class,
				"brokenSpectralBrick", 217, this, 64, 1, true);
		EntityRegistry.registerModEntity(EntityDynamite.class, "dynamite", 218,
				this, 64, 1, true);
		EntityRegistry.registerModEntity(EntityDynamiteSnowball.class,
				"dynamiteSnowball", 219, this, 64, 1, true);
		EntityRegistry.registerModEntity(EntityFungusSpore.class,
				"fungusSpore", 220, this, 64, 1, true);
		EntityRegistry.registerModEntity(EntityCorruptedSoul.class,
				"corruptedSoul", 221, this, 32, 1, true);
		EntityRegistry.registerModEntity(EntityHelpfulSoul.class,
				"helpfulSoul", 222, this, 32, 1, true);
		EntityRegistry.registerModEntity(EntityPurifiedSoul.class,
				"purifiedSoul", 223, this, 64, 1, true);
		EntityRegistry.registerModEntity(EntityBrokenCSBrick.class,
				"brokenCSBrick", 224, this, 64, 1, true);
		EntityRegistry.registerModEntity(EntitySwiftDust.class, "swiftDust",
				225, this, 64, 1, true);
		EntityRegistry.registerModEntity(EntityShineDust.class, "shineDust",
				226, this, 64, 1, true);
		EntityRegistry.registerModEntity(EntityLoveLetter.class, "loveLetter",
				227, this, 64, 1, true);
		EntityRegistry.registerModEntity(EntityHateMail.class, "hateMail", 228,
				this, 64, 1, true);
		...
		if (StuffWorthThrowingConfig.spawnTorturedSouls) {
			EntityRegistry.addSpawn(EntityTorturedSoul.class, 1, 1, 1,
					EnumCreatureType.monster, BiomeGenBase.swampland);
			EntityRegistry.addSpawn(EntityCorruptedSoul.class, 1, 1, 1,
	...
	public static void EntityEgg(Class<? extends Entity> entity,
